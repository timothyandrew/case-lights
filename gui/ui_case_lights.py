...
class Ui_CaseLights(object):
    ...
    def retranslateUi(self, CaseLights):
        ...
        self.pushButton_3.setText(_translate("CaseLights", "Pause"))
        self.pushButton_4.setText(_translate("CaseLights", "White"))
        self.pushButton_7.setText(_translate("CaseLights", "N/A"))
        self.pushButton.setText(_translate("CaseLights", "RGB"))
        self.pushButton_5.setText(_translate("CaseLights", "Pulse"))
        self.pushButton_6.setText(_translate("CaseLights", "Clear"))
